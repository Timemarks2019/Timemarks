...
public class ComparisionResult {
    ...
    private String total_right_questions;
    private String AnswerId;
    private String unique_exam_code;
    ...
    public String getTotal_right_questions() {
        return total_right_questions;
    }

    public void setTotal_right_questions(String total_right_questions) {
        this.total_right_questions = total_right_questions;
    }
    ...
    public String getUnique_exam_code() {
        return unique_exam_code;
    }

    public void setUnique_exam_code(String unique_exam_code) {
        this.unique_exam_code = unique_exam_code;
    }
